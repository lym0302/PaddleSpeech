...
class DiffSpeechUpdater(StandardUpdater):
    def __init__(self,
                 model: Layer,
                 optimizers: Dict[str, Optimizer],
                 criterions: Dict[str, Layer],
                 dataloader: DataLoader,
                 ds_train_start_epoch: int=1000,
        ...
        self.ds_train_start_epoch = ds_train_start_epoch
    ...
    def update_core(self, batch):
        ...
        if self.state.epoch < self.ds_train_start_epoch:
            if type(
                    self.model
            ...
            loss_fs2 = l1_loss_fs2 + duration_loss + pitch_loss + energy_loss + speaker_loss
...
class DiffSpeechEvaluator(StandardEvaluator):
    def __init__(
            self,
            model: Layer,
            criterions: Dict[str, Layer],
