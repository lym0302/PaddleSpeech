...
from paddlespeech.t2s.models.fastspeech2 import DiffSpeech
from paddlespeech.t2s.models.fastspeech2 import DiffSpeechEvaluator
from paddlespeech.t2s.models.fastspeech2 import DiffSpeechUpdater
from paddlespeech.t2s.modules.diffusion import DiffusionLoss
from paddlespeech.t2s.models.fastspeech2.fastspeech2 import FastSpeech2Loss
...
def train_sp(args, config):
    ...
    updater = DiffSpeechUpdater(
        ...
        ds_train_start_epoch=config.ds_train_start_epoch,
        output_dir=output_dir,
        only_train_diffusion=config["only_train_diffusion"])

    evaluator = DiffSpeechEvaluator(
        model=model,
        criterions={
            "fs2": criterion_fs2,
            "ds": criterion_ds,
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train a DiffSpeech model.")
